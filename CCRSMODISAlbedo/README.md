...
| Index\_BRDF          | Index file that contains 2-byte integer value (I2) used for BRDF sampling and fitting and computed as described in the data format description document https://data.eodms-sgdot.nrcan-rncan.gc.ca/public/CCRS/Trishchenko\_MODIS\_Albedo/                   | Index\_BRDF          |
